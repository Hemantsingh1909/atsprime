...
- Name: visual-qa.spec.ts >> Responsive Visual QA Audit at 768px
- Location: tests/visual-qa.spec.ts:8:7

# Error details

```
Error: Console errors encountered at 768px: Failed to load resource: the server responded with a status of 400 (), Failed to load resource: the server responded with a status of 400 (), Failed to load resource: the server responded with a status of 400 ()
